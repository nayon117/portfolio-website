    ...
    <div className="mt-16">
      <div>
        <h2 className="text-3xl font-bold border-l-4 border-black">
          <span className="ml-2 text-first"> My Latest Works</span>
        </h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
        ...
        >
          ...
          <div className="card-body">
            ...
            <p>
              Skillify is an advanced e-learning platform designed to offer a
              seamless learning experience. With a blend of user-centric
              features and a rich interface, it caters to both students and
              teachers, providing a conducive environment for learning and
              teaching.
            </p>
        ...
        >
          ...
          <div className="card-body">
            ...
            <p>
              Food Unity is a platform aimed at connecting individuals or
              organizations with surplus food to those in need. The project
              focuses on reducing food waste and addressing hunger by providing
              a user-friendly interface to share and request food items.
            </p>
            <div className="card-actions flex justify-around items-center ">
              <a
                className="btn-style"
        ...
        >
          ...
          <div className="card-body">
            <h2 className="card-title">Title: Automotive Gearup</h2>
            <p>
              Welcome to our automotive website, where you can explore a wide
              range of car brands, view car details, update car listings, and
