    ...
    <div className="my-16">
      <div>
        <h2 className="text-3xl font-bold border-l-4 border-black">
          <span className="ml-2">Certficates</span>
        </h2>
      </div>
        ...
        <div className="card card-compact   bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-center">
              <a href={htmlCer} target='blank' className="btn btn-primary">Show Certificate</a>
            </div>
          </div>
        </div>
        <div className="card card-compact   bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-center">
              <a href={jsCert} target='blank' className="btn btn-primary">Show Certificate</a>
            </div>
          </div>
        </div>
        <div className="card card-compact   bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-center">
              <a href={metaCert} target='blank' className="btn btn-primary">Show Certificates</a>
            </div>
          </div>
        </div>
      </div>
